...
export default async function AnalyticsPage({ searchParams }: SearchProps) {
  ...
  // Aggregate views + track viewers per establishment
    ...
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
        {rows.length === 0 ? (
          ...
          const hasCountries = row.topCountries.length > 0
          const saveRateColor =
          ...
          return (
            <div key={row.id} style={{
              ...
              <Link
                ...
                style={{ justifyContent: 'center', fontSize: '0.78rem', padding: '0.45rem 0.75rem', marginTop: 'auto' }}
              >
